...
class AnalyticsUseCase:
    ...
    def get_order_statistics(self) -> dict:
        ...
        # Note: This would ideally be in repository, but keeping for compatibility
        # In a full refactor, add count methods to repository
    ...
    def calculate_chart_data(self, range_q: str = "monthly") -> Tuple[List[str], List[float], List[int], List[int], List[float]]:
        ...
        if range_q == "yearly":
            ...
            for y, m in months:
                ...
                # Get cancelled orders (would need cancelled_date filter in repository)
                all_orders = self.order_repository.get_all()
                cancelled_filtered = [
